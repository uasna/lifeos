...
export const BLENDER_LIBRARY_CATEGORIES = Object.freeze([
  Object.freeze({ id: "props", label: "Props", count: 0, status: "Primera pieza pendiente", cta: "Agregar prop" }),
  Object.freeze({ id: "materials", label: "Materiales", count: 0, status: "Paleta base pendiente", cta: "Guardar material" }),
  Object.freeze({ id: "environments", label: "Escenarios", count: 0, status: "Sin diorama todavía", cta: "Crear escena" }),
  Object.freeze({ id: "cameras", label: "Cámaras/Luces", count: 0, status: "Setup pendiente", cta: "Guardar setup" }),
  Object.freeze({ id: "renders", label: "Renders", count: 0, status: "Primer preview pendiente", cta: "Agregar render" }),
  Object.freeze({ id: "animations", label: "Animaciones", count: 0, status: "Loop pendiente", cta: "Agregar clip" }),
  Object.freeze({ id: "creatures", label: "Criaturas", count: 0, status: "Bloqueada hasta curso 7", cta: "Ver ruta" }),
  Object.freeze({ id: "characters", label: "Personajes", count: 0, status: "Bloqueado hasta curso 8", cta: "Ver ruta" }),
]);
