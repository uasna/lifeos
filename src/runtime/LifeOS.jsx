// ============================================================
// LIFE OS v30 · Feature view extraction pass
...
const createFeatureViewDeps = ({ persistent, pDispatch, uiDispatch }) => ({
  ...
  CALCULUS_SOURCE_LABEL,
  CALCULUS_DIFFICULTY_LEVELS,
  getCalculusPlanForDate,
  createCalculusInitialState,
  createCalculusCurrent,
  getCalculusAdaptiveMode,
  getCalculusWeakTopics,
  getCalculusVideoRecommendations,
  getCalculusPinnedPracticeForDate,
  getCalculusRecentHistory,
  getCalculusSeenTopicsUntil,
  getCalculusDifficultyDisplay,
  ...
  buildWardrobeWeek,
  getSecondsUntilNextScheduleWeek,
});
...
function CalculusTrainerView() {
  ...
  return <CalculusTrainerViewFeature deps={createFeatureViewDeps({ persistent, pDispatch, uiDispatch })}/>;
}
function RocketLeagueView() {
  const { persistent, pDispatch } = useAppData();
  const { uiDispatch } = useAppUI();
  return <RocketLeagueViewFeature deps={createFeatureViewDeps({ persistent, pDispatch, uiDispatch })}/>;
}
function QuestsView() {
  const { persistent, pDispatch } = useAppData();
  const { ui, uiDispatch }        = useAppUI();
